...
AI_CORE={
    ...
    'ranking','fine-tuning llms','transformers','pytorch','tensorflow','vector database','recommendation','fiass','pinecone','qdrant','weaviate','openai','hugging face','mlops','a/b testing','model deployment','evaluation','xgboost','scikit-learn','image classification','speec recognition','computer vision','generative AI'}
...
def extract_flat_row(c):
    ...
    if c['candidate_id'] == 'CAND_0000001':
        ...
        print("AI scores:", ai_assess_scores)
        print("Average:", avg_ai_assess)
...
input_path = Path(r"C:\Users\husai\OneDrive\Desktop\redrob_1\data\candidates.jsonl")
output_dir = Path(r"C:\Users\husai\OneDrive\Desktop\redrob_1\outputs")
...
with (
    open(flat_path, 'w', newline='', encoding='utf-8') as ff,
